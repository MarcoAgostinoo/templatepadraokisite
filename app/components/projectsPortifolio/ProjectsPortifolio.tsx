...
export default function ProjectsPortfolio({
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-blue-900 py-12 sm:py-16 md:py-20 lg:py-32">
      ...
      <div className="relative container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="mx-auto mb-8 max-w-3xl text-center sm:mb-12 md:mb-16">
          <span className="mb-2 inline-block rounded-full bg-blue-500/10 px-3 py-1 text-xs font-medium tracking-wider text-blue-400 uppercase sm:mb-3 sm:px-4 sm:py-1.5 sm:text-sm">
            Portfólio
          </span>
          <h2 className="mb-4 bg-gradient-to-r from-white via-blue-400 to-blue-500 bg-clip-text text-2xl leading-tight font-bold text-transparent sm:mb-6 sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl">
            Nossos Projetos em Destaque
          </h2>
          <p className="px-2 text-base text-blue-100 sm:px-0 sm:text-lg md:text-xl">
        ...
        <div className="relative px-2 sm:px-4 md:px-0">
          ...
          <button
            ...
            role="button"
            tabIndex={0}
            className={`${NAV_PREV_CLASS} absolute top-1/2 left-0 z-20 hidden -translate-y-1/2 transform cursor-pointer rounded-md border border-blue-400 bg-blue-800 p-2 text-blue-400 transition-all hover:bg-blue-400 hover:text-white focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none sm:left-2 sm:block sm:p-3 md:-left-6 lg:-left-12`}
          >
            <FiArrowLeft
              size={20}
          ...
          <button
            ...
            role="button"
            tabIndex={0}
            className={`${NAV_NEXT_CLASS} absolute top-1/2 right-0 z-20 hidden -translate-y-1/2 transform cursor-pointer rounded-md border border-blue-400 bg-blue-800 p-2 text-blue-400 transition-all hover:bg-blue-400 hover:text-white focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-blue-900 focus:outline-none sm:right-2 sm:block sm:p-3 md:-right-6 lg:-right-12`}
          >
            <FiArrowRight
              size={20}
              className="sm:h-6 sm:w-6"
        ...
        <div className="mt-4 text-center sm:hidden">
          <p className="animate-pulse text-xs text-blue-300/70">
